...
{
    public class DonHangChinhThuc: PropertyChangedBase
    {
        ...
        public DonHangChinhThuc(DonHangTamThoi donHang)
        {
            NgayDatHang = donHang.NgayDatHang;
            TenNguoiBan = donHang.TenNguoiBan;
            LienHeNguoiBan = donHang.LienHeNguoiBan;
        ...
        public double TienThuHo
        {
            ...
            {
                _tienThuHo = value;
                PhiThuHo = _tienThuHo == 0 ? 0 : ThamSoBUS.GetPhiThuHo ( );
        ...
        public double PhiThuHo
        {
            ...
            {
                _phiThuHo = value;
                TongThanhTien = PhiVanChuyen + PhiThuHo + PhiPhatSinh;
        ...
        public double SoKM
        {
            ...
            {
                _soKm = value;
                PhiVanChuyen = _soKm * ThamSoBUS.GetSoTienTrenKm ( );
                NotifyOfPropertyChange(() => SoKM);
            }
        }
